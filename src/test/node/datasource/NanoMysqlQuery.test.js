...
const MysqlQuery = require("../../../main/node/datasource/NanoMysqlQuery");

describe("NanoMysqlQuery", () => {
    ...
    it("should fail to execute query", async () => {
        ...
        const expectedException =  exceptionBuilder.build("DATABASE_QUERY", "Error during execute query", errorCode.INTERNAL_SERVER_ERROR, error);
